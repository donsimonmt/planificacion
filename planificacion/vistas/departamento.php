...
?>
	...
	<section id="login" class="container">
		<div id="titulo"><h2>Administrar Departamentos</h2></div>
		<div  class="container col-md-12 col-sm-12 well"><br>
		<form class="form-horizontal">
			
			<div class="form-group">
					<label for="Código"class="control-label col-md-4 col-sm-4 col-xs-7">Código</label>
				<div class="col-md-4 col-sm-6 col-xs-12">
					<input class="form-control" type="text" id="cod_dep" name="cod_dep" maxlength="8"    
					autofocus required>
				</div>
			</div>			
			<div class="form-group">
				...
				<div class="col-md-4 col-sm-6 col-xs-12">
					<input class="form-control" type="text" id="nom_dep" name="nombre"  required>
				</div>
			</div>
			...
			<div class="form-group">
				<div class="col-md-8 col-md-offset-2 col-sm-4 col-sm-offset-4 ">
				   ...
				   <button type="button" id="enviar" onClick="registrarDep();"  class="btn btn-primary" value="Registrar">
				    ...
				    <button type="button" id="cancelar" onClick="cancela_sala();" class="btn btn-danger" value="Cancelar"> 
